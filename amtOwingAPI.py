...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
   ...
   <body style="background-color:#ffffff;" data-new-gr-c-s-check-loaded="14.1104.0" data-gr-ext-installed="">
      <div style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;"> {senderName}({senderAddr}) has sent you ${amount} on Polygon Testnet through Xade </div>
                                                         ...
                                                         <tbody>
                                                            <tr>
                                                               <td style="width:600px;">
                                                                  <a href="https://bit.ly/xadefinance" target="_blank" style="color: #2e58ff; text-decoration: none;">
                                       ...
                                       <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                             <tbody>
                                                <tr>
                                                   <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                      <div style="font-family:Lato,'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#434245;">
                                                         Woohoo! You've just received a payment of ${amount} from {senderName}, who clearly understands the value of your awesomeness. Time to celebrate with a victory dance and maybe a little online shopping spree (responsibly, of course). Thanks, {senderName}, you're the real MVP!
                                                </tr>
                                                <tr>
                                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                ...
                                                <br />
                                                <br />
                                                <a href="https://bit.ly/xadefinance" style="display: inline-block; background: #0080FF; color: white; font-family: Lato,'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 18px; font-weight: bold; line-height: 40px; margin: 0; text-decoration: none; text-transform: uppercase; padding: 10px 25px; mso-padding-alt: 0px; width:auto; border-radius:16px;" target="_blank"> Claim Now </a>
                                                <div style="font-family:Lato,'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#434245;">
...
"""
    ...
    if doc:
        collection.update_one(
            ...
            {
                "$set": {
                    "Amount": doc.get("Amount") + amount,
                }
            },
        )

    else:
        collection.insert_one({"Email": receiver, "Amount": amount})
...
def mainnetPart1():
    ...
    senderAddr = obj.get("senderAddr")
    senderAddr = senderAddr[:5] + "..." + senderAddr[-3:]
    doc = collection2.find_one({"Email": receiver})
...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
   ...
   <body style="background-color:#ffffff;" data-new-gr-c-s-check-loaded="14.1104.0" data-gr-ext-installed="">
      <div style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;"> {senderName}({senderAddr}) has sent you ${amount} on Polygon Mainnet through Xade </div>
      <div style="background-color:#ffffff;">
      <!--[if mso | IE]>
      <table
         align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:600px;" width="600"
...
"""
    ...
    if doc:
        ...
        collection2.insert_one({"Email": receiver, "Amount": amount})
